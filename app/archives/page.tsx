  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold tracking-tighter mb-8">Archives</h1>
          ...
          <div className="grid gap-6">
            {articles.map((article: Article) => (
              ...
              >
                ...
                <p className="text-foreground line-clamp-2">{article.content}</p>
              </article>
            ))}
          </div>
        ) : (
          <p className="text-muted-foreground">No archived articles available.</p>
        )}
